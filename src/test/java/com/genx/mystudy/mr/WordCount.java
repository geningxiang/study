...
public class WordCount {
    ...
    public static void main(String[] args) throws Exception {
        ...
        conf.set("fs.defaultFS", "hdfs://test104:8020");
        conf.set("fs.hdfs.impl","org.apache.hadoop.hdfs.DistributedFileSystem");
        conf.set("dfs.client.block.write.replace-datanode-on-failure.policy", "NEVER");

        String[] ss = new String[]{"/data/1-kpi/1.log", "/result/1.log"};

        String[] otherArgs = new GenericOptionsParser(conf, ss).getRemainingArgs();
        System.out.println("###########################");
        System.out.println(StringUtils.join(otherArgs, ","));
